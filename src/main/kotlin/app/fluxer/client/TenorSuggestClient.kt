...
public class TenorSuggestClient(
   ...
   *
   * Returns:
   * 	[NetworkResult.Success] with [kotlin.collections.List<kotlin.String>] if the request was
   * successful.
   * 	[NetworkResult.Failure] with a [NetworkError] if the request failed.
   */
  public suspend fun getTenorSearchSuggestions(
    q: String,
    locale: Locale? = null,
