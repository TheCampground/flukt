...
public class UsersMeMfaSmsDisableClient(
  private val httpClient: HttpClient,
) {
  /**
   * Disable SMS multi-factor authentication
   * Disable SMS-based multi-factor authentication on the current account. Requires sudo mode
   ...
   */
  public suspend fun disableSmsMfa(sudoVerificationSchema: SudoVerificationSchema,
      apiConfiguration: ApiConfiguration = ApiConfiguration()): NetworkResult<Unit> {
    val basePath = apiConfiguration.basePath.trimEnd('/')
    val url = basePath + """/users/@me/mfa/sms/disable"""
