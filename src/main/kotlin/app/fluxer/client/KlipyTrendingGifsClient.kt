...
public class KlipyTrendingGifsClient(
   ...
   */
  public suspend fun getKlipyTrendingGifs(locale: Locale? = null, apiConfiguration: ApiConfiguration
      = ApiConfiguration()): NetworkResult<List<KlipyGifResponse>> {
    val basePath = apiConfiguration.basePath.trimEnd('/')
    val url = buildString {
      append(basePath)
      append("""/klipy/trending-gifs""")
