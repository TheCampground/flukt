...
public class PremiumReactivateSubscriptionClient(
   ...
   */
  public suspend fun reactivateSubscription(apiConfiguration: ApiConfiguration =
      ApiConfiguration()): NetworkResult<Unit> {
    val basePath = apiConfiguration.basePath.trimEnd('/')
    val url = basePath + """/premium/reactivate-subscription"""
