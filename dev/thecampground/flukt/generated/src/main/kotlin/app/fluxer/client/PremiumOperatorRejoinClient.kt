...
public class PremiumOperatorRejoinClient(
   ...
   */
  public suspend fun rejoinOperatorGuild(apiConfiguration: ApiConfiguration = ApiConfiguration()):
      NetworkResult<Unit> {
    val basePath = apiConfiguration.basePath.trimEnd('/')
    val url = basePath + """/premium/operator/rejoin"""
