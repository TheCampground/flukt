...
public data class MessageResponseSchema(
  /**
  ...
  @param:JsonProperty("referenced_message")
  @get:JsonProperty("referenced_message")
  @get:Valid
  public val referencedMessage: MessageBaseResponseSchema? = null,
)
