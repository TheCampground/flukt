...
public class GuildsStickersBulkClient(
  private val httpClient: HttpClient,
) {
  /**
   * Bulk create guild stickers
   * Bulk create guild stickers. Requires manage_emojis permission. Creates multiple stickers in a
   ...
   */
  public suspend fun bulkCreateGuildStickers(
    ...
    val url = basePath + """/guilds/${guildId}/stickers/bulk"""
