...
public class PacksEmojisBulkClient(
  private val httpClient: HttpClient,
) {
  /**
   * Bulk create pack emojis
   * Creates multiple emojis within the specified pack in a single bulk operation. Accepts an array
   * of emoji definitions, each containing name and image data. Returns a response containing all
